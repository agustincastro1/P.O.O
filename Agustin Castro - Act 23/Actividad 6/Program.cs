    ...
    */
    internal class Program
    {
        public class Libro
        {
            ...
            // Propiedades de solo lectura (solo tienen get)
    ...
    public class BibliotecaCentral
    {
        ...
        {
            Console.WriteLine("--- CARGAR CATÁLOGO DE LIBROS ---");
            ...
            while (true)
            {
                ...
                // Condición de salida con comparaciones directas
        ...
        // 2. ListarCatalogo(): Muestra la lista y la propiedad .Count
        ...
        // 3. FiltrarPorAnio(): Muestra libros publicados antes de un año límite
        public void FiltrarPorAño()
        {
            Console.WriteLine("Filtrar libros por año");
            Console.Write("Ingrese un año para listar las obras más antiguas: ");
        ...
        // 4. RemoverLibro(): Busca por título y elimina mediante .Remove()
